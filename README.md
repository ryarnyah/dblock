...
- **linux** [amd64](https://github.com/ryarnyah/dblock/releases/download/0.1.1/dblock-linux-amd64) [386](https://github.com/ryarnyah/dblock/releases/download/0.1.1/dblock-linux-386) [arm](https://github.com/ryarnyah/dblock/releases/download/0.1.1/dblock-linux-arm) [arm64](https://github.com/ryarnyah/dblock/releases/download/0.1.1/dblock-linux-arm64)
- **windows** [amd64](https://github.com/ryarnyah/dblock/releases/download/0.1.1/dblock-windows-amd64) [386](https://github.com/ryarnyah/dblock/releases/download/0.1.1/dblock-windows-386)
- **darwin** [amd64](https://github.com/ryarnyah/dblock/releases/download/0.1.1/dblock-darwin-amd64)

```bash
sudo curl -L https://github.com/ryarnyah/dblock/releases/download/0.1.1/dblock-linux-amd64 -o /usr/local/bin/dblock && sudo chmod +x /usr/local/bin/dblock
```
...
#### Running with Docker
```bash
docker run ryarnyah/dblock-linux-amd64:0.1.1 <option>
```
